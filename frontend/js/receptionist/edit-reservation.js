const app = Vue.createApp({
    ...
    methods: {
        ...
        editReservation() {
            ...
            // iscemo id za izbrano masazo in maserko
            ...
            axios.put(`http://localhost:8080/api/receptionist/editreservation/${this.reservationId}`, dto)
                .then(response => {
                    alert("Rezervacija uspešno posodobljena!");
                    // preusmeritev nazaj na vse rezervacije
